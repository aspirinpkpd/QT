...
```{r Figure Change from baseline per treatment, warning=FALSE, include=FALSE}
...
```{r Figures of Moxifloxacin PK Profiles, warning=FALSE, include=FALSE}
...
```{r HR effect summary table, warning=FALSE, include=FALSE}
...
```{r time delay effect check HR, warning=FALSE, include=FALSE}
...
```{r HR plot, warning=FALSE, include=FALSE}
...
```{r QT correction, warning=FALSE, include=FALSE}
...
```{r time delay effect check DQT, warning=FALSE, include=FALSE}
# Mean Baseline corrected placebo effect
...
```{r time delay loess DQT, warning=FALSE, include=FALSE}
...
```{r QTc-Concentration Analysis, warning=FALSE, include=FALSE }
#
...
```{r QTc-Concentration Analysis Table, warning=FALSE, include=FALSE}
...
```{r Prediction-Based Diagnosis, warning=FALSE, include=FALSE}
...
```{r Residual-Based diagnostics, warning=FALSE, include=FALSE}
...
```{r Boxplots and q-q plots, warning=FALSE, include=FALSE}
...
```{r boxplots time,warning=FALSE,include=FALSE}
...
```{r boxplots treatment,warning=FALSE,include=FALSE}
...
```{r Quantiles DeltaQTcF, warning=FALSE, include=FALSE}
